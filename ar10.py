...
ar1 = LINETCR.LINE()
ar1.login(token="EGymFXc5KqDLISUGlAk2.WoXuSNFRxJJ4y5tpLNBYaG.A7LW1f6cF6FwLb4s6uqJ4eosrlnUw0hqrAFpoBjeW8E=")
ar1.loginResult()

ar2 = LINETCR.LINE()
ar2.login(token="EGUBPsF3spUFGUHKr6A7.t/IdFcgcW7pVEtQdsL6WzW.RNfWckzrDEZ5x+IHDYvm9X5g5ofFlbaUXSXC+SI+11k=")
ar2.loginResult()

ar3 = LINETCR.LINE()
ar3.login(token="EGquKB2DYe3Xe3JmbS41.f04Z5tIwN8oo0wvkaqNsqq.E4N9wyljwo5CprGjwvzBpYIsRQwZVTMC39veuB33bik=")
ar3.loginResult()

ar4 = LINETCR.LINE()
ar4.login(token="EGwuGNZTxgmKzzdvCm4d.UTyjPKxsevBlRp3J8QqDNq.jV/KkHhas6wsbm2Whr5rDw3kSQ5jiyJXm+OgpJ61M+w=")
ar4.loginResult()

ar5 = LINETCR.LINE()
ar5.login(token="EGQJi6oMnbysh2r8M8r5.hY1gor5CBWozmN09XaJ2nq.hBg4VjF/4n3GJHsH58o4PVaeBai5pBbLgtKpafswICc=")
ar5.loginResult()

ar6 = LINETCR.LINE()
ar6.login(token="EGiuReAucQsVEKSNatQd.JZJ/1Jhb9oyNKqIA+uiyFq.QJ9tVWrZMmhyyulcm7R6vSZVk9u4ZUhWn4aoJ5k/Jys=")
ar6.loginResult()

ar7 = LINETCR.LINE()
ar7.login(token="EGlC1pdwAXgJa8ifvhQa.uA70OmZ6xGXhLjifkBHlgG.wqHsMSr4AfbP8t5NwXO1XPvkDkc2PLshNy8PWSzm9S0=")
ar7.loginResult()

ar8 = LINETCR.LINE()
ar8.login(token="EGHVHQWEY3OGinSx1eBb.bAXEGo6vXQI0VRhomlb3MW.D2Ch7Mnin3AnG1GYCwzuBTbpJ13bOszfgTPgg/E6PZo=")
ar8.loginResult()

ar9 = LINETCR.LINE()
ar9.login(token="EG77xdQ4R1Orpy0JONr9.sq7xakrN1v28/yW8CSq42q.hvNuXc0CC8lDzkLPvkLVKSDpEkIbk2jXcw0cNsrmDzE=")
ar9.loginResult()

ar10 = LINETCR.LINE()
ar10.login(token="EG77xdQ4R1Orpy0JONr9.sq7xakrN1v28/yW8CSq42q.hvNuXc0CC8lDzkLPvkLVKSDpEkIbk2jXcw0cNsrmDzE=")
ar10.loginResult()
...
Bots=[mid,mid2,mid3,mid4,mid5,mid6,mid7,mid8,mid9,mid10,"uc0ec54b277eb5e38f86394cf9676f202"]
